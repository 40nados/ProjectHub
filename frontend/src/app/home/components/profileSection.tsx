    ...
    return (
        <section className="mt-3 min-w-[200px] w-full">
            <div className="flex w-full items-center">
                <div
                    id="circlePhoto"
                    className="ml-3 h-20 w-20 rounded-full bg-[var(--foreground)] flex flex-col justify-center items-center overflow-hidden"
                >
                    {user?.user_photo ? (
            ...
            <div className="w-full flex justify-end">
                <button className="bg-customBlue text-black w-1/3 h-8 hover:bg-[var(--foreground)] hover:text-[var(--background)]">
                    New Post
                </button>
            </div>
        </section>
